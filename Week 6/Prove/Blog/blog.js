...
const articlesContainer = document.querySelector('#dynamic-articles-container');

function renderBlogArticles(bookList) {
    articlesContainer.innerHTML = '';

    // Loop through each book object in our array
    bookList.forEach(book => {
        const entryWrapper = document.createElement('div');
        entryWrapper.classList.add('book-entry');
        ...
        articlesContainer.appendChild(entryWrapper);
    });
}
